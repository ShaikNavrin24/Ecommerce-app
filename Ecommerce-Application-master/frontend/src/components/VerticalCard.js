             ...
             data.map((product,index)=>{
              ...
              <FaStarHalf />
                             ...
                             <div className='flex gap-2'>
                                 ...
                                 <p className='text-red-400 text-sm my-[5px] line-through'>{ displayINRCurrency(product?.price)  }</p>
                             </div>
                             <button className='text-sm  bg-sky-300 hover:bg-sky-400 font-semibold hover:scale:105 text-white px-3 py-0.5 rounded-full' onClick={(e)=>handleAddToCart(e,product?._id)}>Add to Cart</button>
                         </div>
                     </Link>
                 )
             })
