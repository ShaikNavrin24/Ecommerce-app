...
const BannerProduct = () => {
  ...
  return (
    <div className='container mx-auto px-8 rounded'>
        <div className='h-56 md:h-80  w-full relative bg-slate-200 shadow-sm'>
             ...
             
             {
                desktopImages.map((imageURL,index)=>{
                   return(
                    <div className='w-full h-full min-w-full min-h-full  duration-700' key={imageURL} style={{transform:`translateX(-${currentImage*100}%)`}}>
